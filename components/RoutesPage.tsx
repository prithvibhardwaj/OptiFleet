...
const optimizedRoutes = [
  {
    ...
    stops: [
      ...
      { id: 2, address: '456 Ang Mo Kio St 21', customer: 'Clean Services', eta: '10:30', status: 'in-progress' },
      { id: 3, address: '789 Bedok North Ave 1', customer: 'Fresh Laundry', eta: '11:45', status: 'pending' },
      { id: 4, address: '234 Tampines St 21', customer: 'BuildMaster', eta: '13:00', status: 'pending' },
    ],
    distance: '42.3 km',
    duration: '4h 15m',
    fuelCost: '$31.20',
  ...
  },
  {
    ...
    driver: 'Sarah Tan',
    stops: [
      { id: 1, address: '890 Woodlands Ave 6', customer: 'Premium Catering', eta: '08:30', status: 'completed' },
      { id: 2, address: '567 Yishun Ring Rd', customer: 'CoolAir Servicing', eta: '09:45', status: 'completed' },
      { id: 3, address: '321 Pasir Ris Dr 3', customer: 'Swift Movers', eta: '11:00', status: 'in-progress' },
      { id: 4, address: '678 Bukit Batok West Ave 6', customer: 'Elite Cleaners', eta: '12:30', status: 'pending' },
    ],
    distance: '38.7 km',
    duration: '3h 50m',
    fuelCost: '$28.50',
  ...
  },
  {
    ...
    driver: 'Amy Wong',
    stops: [
      { id: 1, address: '345 Hougang Ave 8', customer: 'Fresh Pest Solutions', eta: '09:00', status: 'completed' },
      { id: 2, address: '234 Marine Parade Rd', customer: 'Ocean Laundry', eta: '10:15', status: 'in-progress' },
      { id: 3, address: '567 Serangoon North Ave 1', customer: 'North Supplies', eta: '11:30', status: 'pending' },
      { id: 4, address: '432 Jurong West St 52', customer: 'West Catering', eta: '13:00', status: 'pending' },
      { id: 5, address: '789 Queenstown Ave 3', customer: 'Central Services', eta: '14:15', status: 'pending' },
    ],
    distance: '51.2 km',
    duration: '5h 20m',
    fuelCost: '$37.80',
